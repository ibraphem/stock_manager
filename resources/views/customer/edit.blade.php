          ...
          <!-- /.box -->
            ...
            <div class="box">
            	<div class="box-header">
            		<div class="box-header">
		              <h3 class="box-title">@if(!empty($customer)){{__('Edit')}} @else {{__('Create')}} @endif {{__('Customer')}}</h3><a class="btn btn-small btn-primary pull-right" href="{{ URL::to('customers') }}"><i class="fa fa-list"></i>&nbsp; {{__('List')}}</a>
		            </div>
            	</div>
            </div>
          <div class="box">
