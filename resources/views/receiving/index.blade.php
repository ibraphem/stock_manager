                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="form-control-static"><b>@{{ amount_tendered | currency}}</b></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="form-control-static"><b>@{{ payment | currency}}</b></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="supplier_id" class="col-sm-6 control-label">{{trans('receiving.amount_dues')}}</label>
                                    <div class="col-sm-6">
                                        <p class="form-control-static"><b>@{{amount_tendered - payment | currency}}</b></p>
                                    </div>
                                </div>
                                <div>&nbsp;</div>
                                <div class="form-group">
