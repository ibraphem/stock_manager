                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                    {{ Form::select(__('payment_type'), ['None' => __('None'),'Cash' => __('Cash'), 'Cheque' => __('Cheque'), 'DebitCard' => __('Debit Card'), 'Transfer' => __('Transfer')], null, array('class' => 'form-control','placeholder'=>__('Select a payment type'),'required')) }}
                                    </div>
                                </div>
                            </div>
                        </div>
